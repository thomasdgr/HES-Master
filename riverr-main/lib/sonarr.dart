...
class Sonarr extends StatefulWidget {
  const Sonarr({Key? key}) : super(key: key);

  @override
  SonarrState createState() => SonarrState();
}

class SonarrState extends State<Sonarr> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => SearchResultsPage(
            fetcher: () =>
                Fetchers.searchMedia(MediaType.movie, _searchController.text, context)),
      ),
    );
  }
        ...
        children: [
          ...
          Expanded(
            child: Padding(
              ...
              child: MediaList(
                fetcher: () => Fetchers.fetchWatched(MediaType.movie, context),
          ...
          Expanded(
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: MediaList(
                fetcher: () => Fetchers.fetchRecommended(MediaType.movie, context),
                itemHeight: MediaQuery.of(context).size.height / 3,
                itemWidth: MediaQuery.of(context).size.width / 3,
